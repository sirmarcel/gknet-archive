...
data = load(results / "test_set_errors/nomad.nc").forces * 1e3

fig, ax = fig_and_ax(figsize=(colwidth * 0.95, 4.0))
...
ax.set_xlabel(f"Cutoff in Å (offset for visibility)")
...
savefig(fig, img / f"test_set_errors.pdf")
