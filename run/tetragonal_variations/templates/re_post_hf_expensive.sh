...
gknet out gk --freq {{freq}} --maxsteps {{maxsteps}} --total -o gk_$1.virials.every_2.nc heat_flux_$1.virials.every_2.nc
gknet out gk --freq {{freq}} --maxsteps {{maxsteps}} -o gk_$1.virials.every_2.nc heat_flux_$1.virials.every_2.nc
gknet out gk --freq {{freq}} --maxsteps {{maxsteps}} --total -o gk_$1.every_2.nc heat_flux_$1.every_2.nc
gknet out gk --freq {{freq}} --maxsteps {{maxsteps}} -o gk_$1.every_2.nc heat_flux_$1.every_2.nc
