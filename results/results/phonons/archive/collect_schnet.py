...
np.savez_compressed(
    f"tetra_schnet_n96.npz",
    **get_phonons(get_dir() / f"new_phonons/tetragonal/phonons_s2/"),
)
np.savez_compressed(
    f"tetra_schnet_n324.npz",
    **get_phonons(get_dir() / f"new_phonons/tetragonal/phonons_s3/"),
)


np.savez_compressed(
    f"mono_schnet_n96.npz",
    **get_phonons(get_dir() / f"new_phonons/monoclinic/phonons_s2/"),
)
np.savez_compressed(
    f"mono_schnet_n324.npz",
    **get_phonons(get_dir() / f"new_phonons/monoclinic/phonons_s3/"),
)
